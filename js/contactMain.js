...
// Sweetalert
function alertWrong() {
    swal("¡Información inválida!", "Algunos datos están incorrectos", "error");
}

function alertSuccess() {
    swal("¡Mensaje enviado!", "Te contactaré lo más pronto posible", "success");
}
...
function validationName() {
    ...
    if (nameRegex.test(name)) {
        ...
        alert_name_txt.insertAdjacentHTML("afterbegin", `Nombre incorrecto`);
        return false;
    }
}
...
function validationPhone() {
    ...
    if (phoneRegex.test(phone) && (repeatedDigits <= 5)) {
        ...
        alert_phone_txt.insertAdjacentHTML("afterbegin", `Teléfono incorrecto`);
        return false;
    }
}
...
function validationMessage() {
    ...
    if (message > 10) {
        ...
        alert_message_txt.insertAdjacentHTML("afterbegin", `Mensaje incorrecto`);
        return false;
    }
}
